...
import com.liuwei1995.zxing.zxing.Contents;
...
public abstract class ResultHandler {
    ...
    private void sendMMSFromUri(String uri, String subject, String body) {
        ...
        if (subject == null || subject.isEmpty()) {
            putExtra(intent, "subject", msg_default_mms_subject);
        } else {
   ...
   public final void launchIntent(Intent intent,String title,String mesage,String positiveButton) {
        try {
            rawLaunchIntent(intent);
        } catch (ActivityNotFoundException ignored) {
            show(title, mesage, positiveButton);
        }
    }

    private void show(String title, String mesage, String positiveButton) {
